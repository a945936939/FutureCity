  ...
  <body>
      ...
      <div class="commutes-info">
        ...
        <div class="commutes-destinations">
          <div class="destinations-container">
            ...
            <!-- <button class="add-button" id = "dest-button">
    ...
    <script>
      ...
      const destinationPanelEl = {
        ...
        scrollLeftButton:
          commutesEl.destinationPanel.querySelector(".left-control"),
        scrollRightButton:
      ...
      function Commutes(configuration) {
          ...
          for (const destination of configuration.initialDestinations) {
            ...
            placesService.getDetails(
              ...
              function (place) {
                ...
                const travelMode =
                  destination.travelMode || configuration.defaultTravelMode;
                ...
                getDirections(destinationConfig).then((response) => {
                  ...
                  if (
                    callbackCounter === configuration.initialDestinations.length
                  ) {
        ...
        function initCommutesPanel() {
          ...
          addCommutesButtonEls.forEach((addButton) => {
            addButton.addEventListener("click", () => {
              ...
              const travelMode =
                configuration.defaultTravelMode || TravelMode.DRIVING;
        ...
        function initCommutesModal() {
          ...
          destinationModalEl.addButton.addEventListener("click", () => {
            ...
            let unselectedTravelMode = "";

            //   ADDED CODE
            // Add a second trip which has the opposite (transport / transit)
            if (selectedTravelMode == "DRIVING") {
              unselectedTravelMode = "TRANSIT";
            } else if (selectedTravelMode == "TRANSIT") {
              unselectedTravelMode = "DRIVING";
            }
            addDestinationToList(destinationToAdd, selectedTravelMode);

            addDestinationToList(destinationToAdd, unselectedTravelMode);
            destinationFormReset();
            hideElement(commutesEl.modal);
            hideElement(commutesEl.destinationPanel.addButton);
          });
        ...
        function validateDestinationInput(destinationToAdd) {
          ...
          if (!destinationToAdd) {
            ...
            // allow multiple routes with same destinations by commenting out the following code
            // } else if (
            //     destinations &&
            //     destinations.find(
            //         destination =>
        ...
        function buildDestinationCardTemplate(
          ...
          switch (destinationOperation) {
            ...
            case DestinationOperation.EDIT:
              const activeDestinationEl = destinationPanelEl.list.querySelector(
                ".destination.active"
              );
              activeDestinationEl.innerHTML =
                generateDestinationTemplate(destination);
...
;
        ...
        function updateCommutesPanel(
          ...
          if (!destinations.length) {
            ...
            //   hideElement(commutesEl.destinationPanel.destinations-container.add-button);
            activeDestinationIndex = undefined;
            return;
          }
        ...
        function getCommutesInfo(directionResponse, destination) {
          ...
          // <?php
          // $_SESSION['distance']='<script>document.write(directionLeg.distance)</script>';
          // $_SESSION['duration']='<script>document.write(directionLeg.duration.value)</script>';
        ...
        function handleRouteClick(destination, destinationIdx) {
          ...
          const newDestinationEl =
            destinationPanelEl.list.querySelectorAll(".destination")[
              destinationIdx
            ];
        ...
        if (navigator.geolocation) {
          navigator.geolocation.getCurrentPosition((position) => {
            ...
            const CONFIGURATION = {
              ...
              mapsApiKey: "AIzaSyBl8Tbwm2l2G-bhXMTSl71NhYtfzLrCs1M",
            };
