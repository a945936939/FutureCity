...
//-- 4 car trip time
    ...
    //    as a percentage
      $pt_dist_percentage = $pt_distance/($pt_distance + $car_distance) * 100;
...
<script>
    ...
    <div class="fb-share-button" data-href="https://www.emission-tracker.live/Home.php" data-layout="button_count" data-size="large"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fwww.emission-tracker.live%2FHome.php&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">Share</a>
    </div>
