...
$user_trip_length=$_GET["user_trip_length"];
$user_trip_emissions=$_GET["user_trip_emissions"];
...
//Y-m-d H:i:s'
//04/05/2022, 23:02:53
$query="insert into user_trip_2 (user_trip_id,  user_id, user_trip_start_time, user_trip_end_time, transport_id, user_trip_length, user_trip_emissions) values (next value for user_trip_seq,".$user_id.",'".strval(date('Y-m-d H:i:s',strtotime($user_trip_start_time)))."','".strval(date('Y-m-d H:i:s',strtotime($user_trip_end_time)))."',".$transport_id.",".$user_trip_length.",".$user_trip_emissions.");";
